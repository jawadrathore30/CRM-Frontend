				...
				{showSuccessMessage ? (
					...
					<motion.div
						...
						<form
							...
							{/* User info and admin controls section */}
									...
									<div className="grid md:grid-cols-2 gap-6">
										...
										<motion.div
											...
											<Select
												...
												<SelectTrigger className="h-11 rounded-lg border-slate-200 dark:border-slate-700/50 bg-white dark:bg-slate-800/50 focus:ring-primary text-slate-900 dark:text-white">
										...
										<div className="grid md:grid-cols-2 gap-6">
											...
											<motion.div
												...
												<Label
													htmlFor="dribble"
													className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center gap-2">
													<Dribbble className="h-4 w-4 text-[#EA4C89]" />
													Dribbble
												</Label>
												<div className="relative">
													<Input
