	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			setTimeout(() => {
				...
				if (onPasswordChange) {
					onPasswordChange(employee.id, formData.newPassword);
				}
				...
				{showSuccessMessage ? (
					<motion.div
						...
						<p className="text-slate-600 dark:text-slate-400 text-center mb-6">
							The employee's password has been successfully changed.
						</p>
						<Button
							onClick={handleClose}
						...
						<div className="relative flex items-center justify-between px-8 py-6 border-b border-slate-200 dark:border-slate-700">
							<div className="flex flex-col">
								...
								<p className="text-slate-500 dark:text-slate-400 text-sm mt-1">
									Update password for this employee account
								</p>
							</div>
							<Button
								variant="ghost"
						...
						<div className="px-8 py-6 bg-slate-50/80 dark:bg-slate-800/50 border-b border-slate-200 dark:border-slate-700/50">
							<div className="flex items-center gap-4">
								<Avatar className="h-16 w-16 border-2 border-white dark:border-slate-700 shadow-md">
									<AvatarImage
										src={
											employee.avatar || "/placeholder.svg?height=64&width=64"
										}
										alt={
											employee.name ||
								...
								<motion.div
									...
									<div className="text-xs">
										...
										<p className="mt-1">
											...
											{employee.name ||
												`${employee.firstName} ${employee.lastName}`}
											. The employee will need to use this new password for
											their next login.
										</p>
									</div>
								</motion.div>
