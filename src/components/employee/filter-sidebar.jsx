...
import { Mail, X, User, Filter, Briefcase } from "lucide-react";
							...
							<motion.div
								...
								<div className="flex flex-wrap gap-2">
									...
									<div
										...
										<div className="flex items-center gap-2">
											<Checkbox
												checked={roleFilters.management}
												className={
													roleFilters.management
									...
									<div
										className={`px-3 py-2 rounded-lg border cursor-pointer transition-all ${
											roleFilters.accounting
												? "bg-amber-100 border-amber-300 text-amber-800 dark:bg-amber-900/30 dark:border-amber-800/30 dark:text-amber-400"
												: "bg-white border-slate-200 text-slate-700 dark:bg-slate-800/50 dark:border-slate-700 dark:text-slate-300"
										}`}
										onClick={() =>
											setRoleFilters((prev) => ({
										...
										<div className="flex items-center gap-2">
											<Checkbox
												checked={roleFilters.accounting}
												className={
													roleFilters.accounting
