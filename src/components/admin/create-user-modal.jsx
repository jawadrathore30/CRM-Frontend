						...
						<div className="grid md:grid-cols-2 gap-6">
							...
							<motion.div
								...
								<RadioGroup
									...
									<div className="flex flex-1 items-center space-x-2 bg-white dark:bg-slate-800/50 p-3 rounded-lg border border-slate-200 dark:border-slate-700/50 transition-colors hover:bg-slate-50 dark:hover:bg-slate-700/30">
										<RadioGroupItem
											value="Co Admin"
											id="role-co-admin"
